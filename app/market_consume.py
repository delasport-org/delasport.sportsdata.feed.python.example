...
from app.kafka.models.market import MarketMessage
...
json_deserializer = JSONDeserializer(market_schema.schema_str, from_dict=MarketMessage.from_dict)


def process_message(msg: MarketMessage):
