...
from app.kafka.models.result_settlement import ResultSettlementMessage
...
result_settlement_schema = schema_client.get_schema(settings.CONFLUENT_SCHEMA_ID)
json_deserializer = JSONDeserializer(result_settlement_schema.schema_str, from_dict=ResultSettlementMessage.from_dict)


def process_message(msg: ResultSettlementMessage):
